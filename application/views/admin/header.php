...
<link href="<?php echo base_url(); ?>assets/admin/layout/css/custom.css" rel="stylesheet" type="text/css"/>
  ...
  <script type="text/javascript" src="<?php echo base_url(); ?>assets/admin/layout/scripts/common.js"></script>
		...
		<div class="top-menu">
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					...
					<?php echo $session_data["name"]; ?> </span>
	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="start ">
					<a href="<?php echo base_url(); ?>admin/welcome/category">
					<i class="icon-home"></i>
					<span class="title">Ajax Dropdowns</span>
					<span class="arrow "></span>
					</a>
				</li>
